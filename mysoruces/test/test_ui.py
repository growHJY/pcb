...
class MyWidget(QWidget):
    ...
    def __setUI(self):
        ...
        titleText="广东省2022年度工业互联网边缘计算大赛"
        ...
        label3=QLabel("P3")
        label4=QLabel("P4")
        label5=QLabel("电路板检测信息:")
        self.label6=QLabel("电路板缺陷统计:")
        self.label7=QLabel("字符识别结果:")
        self.label8=QLabel("")
        ...
        Midlayout.addWidget(self.label6)
        Midlayout.addWidget(self.label7)
        Midlayout.addWidget(self.label8)
        ...
        tmp.addWidget(self.btnRobotTrue)
